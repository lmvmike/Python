...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode ((1900,900))#, pygame.FULLSCREEN)
        self.settings.screen_width = self.screen.get_rect().width
        self.settings.screen_height = self.screen.get_rect().height

        pygame.display.set_caption ("Miguel Alien Invasion")

        #instrance to store statisctics and score
        ...
        self.pew_sound = pygame.mixer.Sound("blaster.mp3")


    def run_game(self):
        #Start the main loop for the game

        #display alien, ship, and play
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decrement the number of ships left, update the scoreboard
